...
- **`CACHE_DIR`**: Override the per-user cache base; bypasses platformdirs. See [caching](caching.md).
...
Internal architecture lives in [`CLAUDE.md`](https://github.com/EspenAlbert/tfdo/blob/main/CLAUDE.md). Public API and CLI reference live under [`docs/`](./docs/) and ship via [mkdocs-material](https://squidfunk.github.io/mkdocs-material/).

## License

[MIT](https://github.com/EspenAlbert/tfdo/blob/main/LICENSE).
